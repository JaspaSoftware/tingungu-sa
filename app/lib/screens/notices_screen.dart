              ...
              builder: (context, userSnap) {
                ...
                return StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, noticeSnap) {
                    ...
                    final unreadCount = allIds.where((id) => !readNotices.contains(id)).length;

                    if (unreadCount == 0) return const SizedBox.shrink();

                    return TextButton.icon(
                      onPressed: () => _markAllAsRead(allIds),
                      icon: const Icon(Icons.done_all, color: Color(0xFFFB8B24), size: 20),
                      label: const Text(
                        'Mark all read',
                        style: TextStyle(color: Color(0xFFFB8B24), fontSize: 12),
                      ),
                    );
                  },
                );
      ...
      body: _currentUser == null
          ...
          : StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, userSnapshot) {
                ...
                final List<dynamic> rawReadNotices = userData['read_notices'] ?? [];
                final Set<String> readNoticeIds = rawReadNotices.map((e) => e.toString()).toSet();
                ...
                return StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, noticesSnapshot) {
                    if (noticesSnapshot.connectionState == ConnectionState.waiting) {
                      return const Center(child: CircularProgressIndicator(color: Color(0xFFFB8B24)));
                    }

                    if (!noticesSnapshot.hasData || noticesSnapshot.data!.docs.isEmpty) {
                      return Center(
                        child: Column(
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final notice = noticeDoc.data() as Map<String, dynamic>;
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Icon(
                                    Icons.campaign,
                                    color: isRead ? Colors.grey : const Color(0xFFFB8B24),
                                  ),
                                ),
                                          ...
                                          Expanded(
                                            child: Text(
                                              ...
                                              style: TextStyle(
                                                ...
                                                fontSize: 16,
                                                color: isRead ? Colors.grey[700] : const Color(0xFF3B0D11),
                                              ),
                                            ),
                                          ),
                                          if (!isRead)
                                          ...
                                          if (!isRead)
                                            InkWell(
                                              ...
                                              child: const Padding(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Icon(Icons.check_circle_outline, size: 16, color: Color(0xFFFB8B24)),
                                                    SizedBox(width: 4),
                                                    Text(
                                                      'Mark as read',
                                                      style: TextStyle(
